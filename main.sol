...
contract Trollz is ERC721Enumerable, Ownable {
    ...
    uint256 public price = 700000000000000; //0.07 Ether
    string baseTokenURI;
    bool public saleOpen;
    address member1 = 0x4E5c60C857d399C81b8036bE8a1822ce96aFfDa1; //Member 1
    address member2 = 0x5833A1675BF894abeCF365Fcd8C8741EC7Ad3630; //Member 2
    address member3 = 0xAd3948B4Aa2917c36fc0125C266b323f81805D36; //Member 3
    address member4 = 0x1002CA2d139962cA9bA0B560C7A703b4A149F6e0; //Member 4
    address member5 = 0x49282E5E05fE59A724641eE867641b5883C02E58; //Member 5
    ...
    function earlyBuyTrollz(uint256 _amount) public payable {
        require(earlyBuyers[msg.sender] == true, "You are not whitelisted.");
    ...
    function withdraw() payable public {
        uint256 member1Part = address(this).balance / 4;
        uint256 member2Part = address(this).balance / 2;
        uint256 member3Part = address(this).balance / 10;
        uint256 member4Part = address(this).balance / 10;
        uint256 member5Part = address(this).balance / 20;
        payable(member1).transfer(member1Part);
        payable(member2).transfer(member2Part);
        payable(member3).transfer(member3Part);
        payable(member4).transfer(member4Part);
        payable(member5).transfer(member5Part);
    }
